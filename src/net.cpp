...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Spartacuscoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0xe062c9c3,0x6714946d,0x548e796d
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Spartacuscoin is probably already running."), addrBind.ToString().c_str());
        else
